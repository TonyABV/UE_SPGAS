...
void UInventoryComponent::AddInventoryTags()
{
    ...
    UInventoryComponent::EquipItemTag =
        TagsManager.  //
...
void UInventoryComponent::InitializeComponent()
{
    ...
    {
        ASC->GenericGameplayEventCallbacks.FindOrAdd(UInventoryComponent::EquipItemTag)
            .AddUObject(this, &UInventoryComponent::GameplayEvenCallback);
        ASC->GenericGameplayEventCallbacks.FindOrAdd(UInventoryComponent::DropItemTag)
            .AddUObject(this, &UInventoryComponent::GameplayEvenCallback);
        ASC->GenericGameplayEventCallbacks.FindOrAdd(UInventoryComponent::UnequipItemTag)
            .AddUObject(this, &UInventoryComponent::GameplayEvenCallback);
        ASC->GenericGameplayEventCallbacks.FindOrAdd(UInventoryComponent::EquipNextItemTag)
            .AddUObject(this, &UInventoryComponent::GameplayEvenCallback);
    }
}
...
void UInventoryComponent::AddItemInstance(UInventoryItemInstance* InItemInstance)
{
    if (GetOwner()->HasAuthority())
    {
        ...
        Algo::Sort(Items, [](UInventoryItemInstance* InA, UInventoryItemInstance* InB) { return InA->GetQuantity() < InB->GetQuantity(); });
...
void UInventoryComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
    ...
    if (bShowDebug)
    {
        ...
        {
            GEngine->AddOnScreenDebugMessage(-1, 0, FColor::Purple,
                FString::Printf(TEXT("Tag: %s %d"),  //
