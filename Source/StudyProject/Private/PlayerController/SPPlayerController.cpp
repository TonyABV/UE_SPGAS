...
void ASPPlayerController::OnPossess(APawn* InPawn)
{
    ...
    {
        DeathStateTagDelegate = ASComponent
                                    ->RegisterGameplayTagEvent(FGameplayTag::RequestGameplayTag(TEXT("State.Dead")),  //
                                        EGameplayTagEventType::NewOrRemoved)
                                    .AddUObject(this, &ASPPlayerController::OnPawnDeathStateChanged);
    }
}
