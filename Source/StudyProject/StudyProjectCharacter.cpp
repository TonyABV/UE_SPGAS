    ...
    : Super(ObjectInitializer.SetDefaultSubobjectClass<USPCharacterMovementComponent>(ACharacter::CharacterMovementComponentName))
{
    ...
    AbilitySystemComponent
        ->RegisterGameplayTagEvent(FGameplayTag::RequestGameplayTag(TEXT("State.Ragdoll")),  //
            EGameplayTagEventType::NewOrRemoved)
        .AddUObject(this, &AStudyProjectCharacter::OnRagdollStateChanged);
...
bool AStudyProjectCharacter::ApplayGameplayEffectToSelf(TSubclassOf<UGameplayEffect> Effect, FGameplayEffectContextHandle InEffectContext)
{
...
void AStudyProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
    ...
    if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
    {
        ...
        EnhancedInputComponent->BindAction(
            EquipNextInputAction, ETriggerEvent::Started, this, &AStudyProjectCharacter::OnEquipNextTriggered);
